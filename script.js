// Master IPA Mapping derived from data_set.txt and previous turn data
const MASTER_IPA = {
...
const CHAPTERS = [
    {
        ...
        sections: [
            ...
            { name: "The kit /ɪ/, trap /æ/ revision", instr: "Transcribe these words with the kit /ɪ/ vowel or the trap /æ/ vowel.", words: "tap, mat, trim, strand, tick, rack, lip, drag, pin, rim, lap, grin, lad, wig, scrap, grill, bat, wit, span, lid, valve, stiff, skim, wax, wrist, grip, trap, pill, knit, tram" },
            { name: "The dress /e/ vowel", instr: "Transcribe these words with the dress /e/ vowel.", words: "best, next, web, help, set, well, press, red, let, end, bread, rent, text, pet, head, den, rest, friend, step, dress, bed, bell, neck, desk, spread, pen, wet, mess, hell, ten" },
            { name: "Kit, Trap, Dress Revision", instr: "Transcribe these words with /ɪ/, /æ/ or /e/.", words: "nest, wag, vet, lick, bent, limb, melt, flint, axe, pest, drift, rag, drip, pram, sift, vent, fig, tract, skid, tread, din, nip, sap, deck, gift, dam, frisk, crest, glint, ramp, kilt, plaid, lilt, nick, glen, kit, damp, lag, sniff, crab" },
            { name: "The lot /ɒ/ vowel", instr: "Transcribe these words with the lot /ɒ/ vowel.", words: "top, want, stop, log, stock, cost, rock, hot, golf, box, loss, bomb, spot, god, boss, block, crop, plot, dog, swan, rob, squad, bond, fox, cross, drop, lock, pot, what" },
            { name: "Kit, Trap, Dress, Lot Revision", instr: "Transcribe these words with /ɪ/, /æ/, /e/ or /ɒ/.", words: "quill, keg, sag, twig, silt, flock, crib, pact, sect, cleanse, smack, mop, knock, limp, fad, whim, mend, fizz, amp, bib, wand, squint, slack, scalp, fog, wren, cod, bless, bid, clamp, guild, zap, splint, frill, elm, dock, wasp, cog, whisk, bend" },
            { name: "The strut /ʌ/ vowel", instr: "Transcribe these words with the strut /ʌ/ vowel.", words: "up, run, love, son, plus, front, club, trust, rough, stuff, hub, drug, pub, cut, hull, tough, cup, hunt, plug, blood, bus, bump, fund, truck, bulk, gun, ton, sum, tub, puff" },
            { name: "Five Vowel Revision", instr: "Transcribe words with /ɪ/, /æ/, /e/, /ɒ/ or /ʌ/.", words: "dull, hum, quack, crypt, lust, gloss, tusk, swamp, squat, scrub, scuff, snag, none, swill, cuff, glove, cot, cyst, muck, swat, bulb, whack, tug, fob, bud, stomp, buck, dread, blimp, trot, wok, wad, beg, hob" },
            { name: "The foot /ʊ/ vowel", instr: "Transcribe these words with the foot /ʊ/ vowel.", words: "look, put, good, book, full, woof, hook, nook, wood, pull, took, wolf, stood, cook, foot, crook, hood, rook, brook, bull, wool" },
            { name: "Short Vowels Comprehensive", instr: "Comprehensive revision of all short vowels.", words: "quit, ram, wolf, egg, trick, buzz, scant, swap, cliff, flood, quest, skull, guess, squid, helm, rub, scab, smog, peg, snug, quilt, crack, knot, bull, kick, strut, floss, scrum, book, sweat, cough, slam, duck, sieve, blob, twist, gulf, spell, doll, foot, clump, plait, scan, fix, twelve, blonde, hymn, drum, hook, knack, sculpt, whelk, bronze, frizz, gut, gram, quell, frost, swab, hem, stud, breast, smock, build, pat, milk, realm, blitz, pull, sulk, sob, ant, fib, crumb, stress, sock, spill, smell, pulse, frock, flex, clan, lapse, frog, mud, swim, hump, scamp, clock, wool, pond, cull, lamb, mock, zip, swift, stamp, pant, mob, kiss, weld, quip, script, dud, stood, sand, silk, slop, slab, sprint, plump, crust, whip, bog, disc, rot, mill, gland" }
        ]
    },
    {
        title: "Schwa & Unstressed",
        sections: [
            { name: "Schwa /ə/", instr: "Transcribe with /ə/ in unstressed syllables. Use stress marks.", words: "gallon, above, panda, villain, collapse, syrup, lemon, protect, extra, canal, arrest, tenant, parrot, alpha, campus, welcome, lapel, cactus, collect, bullock, stomach, buttock, correct, woollen, villa, husband, assess, heron, breakfast, atlas, Christmas, maggot, atom, cadet, felon, zebra, possess, melon, hammock, adopt, comma, gazette, gammon, dragon, column, salad, gallop, stigma, ballad, attract" },
            { name: "Schwa /ə/ with <r>", instr: "Transcribe words with <r> in spelling. Use stress marks.", words: "doctor, lizard, terror, copper, butter, monarch, forgive, cover, hover, blizzard, figure, liquor, ponder, forget, rigour, grammar, actor, suffer, concert, offer, persist, whisper, sponsor, vulgar, sulphur, otter, centre, honour, enter, standard, plumber, collar, leopard, mirror, glamour, custard, timber, cupboard, effort, differ" },
            { name: "Polysyllabic Schwa /ə/", instr: "Transcribe polysyllabic words with stress marks.", words: "wilderness, professor, asparagus, customer, abacus, consider, vanilla, photographer, instrument, propeller, predator, savannah, charisma, surrender, conundrum, gorilla, hazardous, prospectus, adamant, astronomer, adaptor" },
            { name: "Unstressed kit /ɪ/", instr: "Transcribe the following words with unstressed kit /ɪ/.", words: "comic, invest, rabbit, women, solid, rapid, visit, epic, biscuit, locket, imposter, bucket, limit, cricket, minute, attic, robin, coffin, rustic, puppet, captive, intent, ticket, classic, profit, resin, haggis, bandit, tonic, Latin, instructor, pocket, promise, plastic, comet, relic, lyric, goblin, statistic, habit, public, passive, cabin, laxative, picnic, rocket, gossip, narrative, olive" },
            { name: "Schwa /ə/ vs kit /ɪ/", instr: "Transcribe either schwa /ə/ or kit /ɪ/ based on your speech.", words: "victim, select, lettuce, necklace, bullet, kebab, palace, anonymous, politics, honest, helmet, character, foreign, menace, magnet, mechanic, tablet, rivet, facet, wallet, minimum, solicitor, forest, tremendous, eldest, mallet, spirit, bannister, cement, maximum, pallet, specific, solace, captain, minister, terrace, pessimist, element, obstinate, philosopher, apprentice, heretic, neglect" },
...
function showView(viewName) {
    ...
    if(viewName === 'exercise') document.getElementById('ipa-input').focus();
}
...
function checkAnswer() {
    ...
    if (cleanInput === correct) {
        ...
        setTimeout(() => {
            state.wordIdx++;
            if (state.wordIdx < state.words.length) renderWord();
            else showView('sections');
        }, 600);
    } else {
        document.getElementById('feedback').textContent = `EXPECTED: ${correct}`;
        document.getElementById('feedback').style.color = 'var(--error)';
    }
}

document.getElementById('exit-btn').onclick = () => showView('sections');
init();
